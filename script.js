    ...
    style: 'mapbox://styles/yangsunsun/clyxa493c00sr01p9dkd9fxeb', // map style URL from Mapbox Studio
    center: [-79.5256, 43.8867],
    zoom: 8.49
    });
    ...
    map.on('mousemove', (event) => {
        ...
        layers: ['trt-cma-mapping-simplified-cikmhr']
        });
        ...
        : `<p>Hover over an area in Toronto CMA!</p>`;
    });
    });
